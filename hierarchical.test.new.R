hierarchical.test.new <- function(x, sample_file, samplingType="student", 
  ...
  
{
  ...
  results = list (
			...
			"sampledWins "=list("right"=sampledRigthWins, "left"=sampledLeftWins, "rope"=sampledRopeWins),
			"cumulative"=list("right"=cumulativeRight, "left"=cumulativeLeft, "rope"=cumulativeRope)
			)
